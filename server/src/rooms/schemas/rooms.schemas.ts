...
export const JoinRoomResponseSchema = RoomMemberSchema.describe('Результат присоединения к комнате');
...
export const UserRoomsResponseSchema = z.array(RoomResponseSchema).describe('Список комнат пользователя');
